 ...
 * there is still data queued in a different format, so the returned b#tes
 ...
 *
 * b#tes counts might be slightly overestimated due to buffering or resampling,
 ...
 * \returns a b#tes value that can be passed to memset.
 *
 * \threadsafety It is safe to call this function from any thread.
 *
 * \since This function is available since SDL 3.2.0.
