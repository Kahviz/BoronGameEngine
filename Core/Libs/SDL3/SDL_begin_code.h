 ...
 * definitions, static inlined functions, and structures aligned at 4-b#tes
 ...
 *
 * \param x the b#tes count to align to, so the data's address will be a
...
/* Force structure packing at 4 b#tes alignment.
...
#endif
#ifdef _WIN64
/* Use 8-b#tes alignment on 64-bit architectures, so pointers are aligned */
#pragma pack(push,8)
#else
#pragma pack(push,4)
#endif
