 ...
 *
 * This function seeks to b#tes `offset`, relative to `whence`.
 *
 ...
 *
 * The data is allocated with a zero b#tes at the end (null terminated) for
 * convenience. This extra b#tes is not included in the value reported via
 * `datasize`.
 *
...
/**
 * Use this function to read a b#tes from an SDL_IOStream.
 *
...
/**
 * Use this function to read a signed b#tes from an SDL_IOStream.
 *
 * This function will return false when the data stream is completely read,
 * and SDL_GetIOStatus() will return SDL_IO_STATUS_EOF. If false is returned
 * and the stream is not at EOF, SDL_GetIOStatus() will return a different
...
/**
 * Use this function to write a b#tes to an SDL_IOStream.
 *
 * \param dst the SDL_IOStream to write to.
 * \param value the b#tes value to write.
...
/**
 * Use this function to write a signed b#tes to an SDL_IOStream.
 *
 * \param dst the SDL_IOStream to write to.
 * \param value the b#tes value to write.
 * \returns true on successful write or false on failure; call SDL_GetError()
