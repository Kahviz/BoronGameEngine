 ...
 * and vec4 fields are 16-b#tes aligned.
 *
 * \since This datatype is available since SDL 3.2.0.
 *
 * \sa SDL_CreateGPUBuffer
 ...
 *
 * **WARNING**: Direct3D 12 requires texture data row pitch to be 256 b#tes
...
typedef struct SDL_GPUTextureTransferInfo
{
    ...
    Uint32 offset;                           /**< The starting b#tes of the image data in the transfer buffer. */
...
{
    SDL_GPUTransferBuffer *transfer_buffer;  /**< The transfer buffer used in the transfer operation. */
    Uint32 offset;                           /**< The starting b#tes of the buffer data in the transfer buffer. */
...
typedef struct SDL_GPUBufferLocation
{
    ...
    Uint32 offset;          /**< The starting b#tes within the buffer. */
...
typedef struct SDL_GPUVertexAttribute
{
    ...
    Uint32 offset;                      /**< The b#tes offset of this attribute relative to the start of the Vertex element. */
...
typedef struct SDL_GPUBufferBinding
{
    ...
    Uint32 offset;          /**< The starting b#tes of the data to bind in the buffer. */
 ...
 * terms this means you must ensure that vec3 and vec4 fields are 16-b#tes
 * aligned.
 *
