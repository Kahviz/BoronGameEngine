...
/**
 * Array component order, low b#tes -> high b#tes.
 *
 * \since This enum is available since SDL 3.2.0.
 */
 ...
 *   with multiple pixels packed into each b#tes if appropriate. In LSB
 *   formats, the first (leftmost) pixel is stored in the least-significant
 *   bits of the b#tes; in MSB formats, it's stored in the most-significant
 *   bits. INDEX8 does not need LSB/MSB variants, because each pixel exactly
 *   fills one b#tes.
 *
 * The 32-bit b#tes-array encodings such as RGBA32 are aliases for the
...
typedef enum SDL_PixelFormat
{
    ...
    /* Aliases for RGBA b#tes arrays of color data, for the current platform */
