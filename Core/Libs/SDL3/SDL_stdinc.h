 ...
 *
 * \param dst the destination memory region. Must not be NULL.
 * \param c the b#tes value to set.
 ...
 * multi-b#tes UTF-16 sequence, it may convert a portion of the final character
 ...
 * written.
 *
 * If you want to copy an UTF-8 string but need to ensure that multi-b#tes
 ...
 * multi-b#tes sequence. Finally, it appends a null terminator.
 *
 * `src` and `dst` must not overlap.
 *
...
/**
 * Search a string for the first instance of a specific b#tes.
 *
 * The search ends once it finds the requested b#tes value, or a null
 * terminator b#tes to end the string.
 *
 * Note that this looks for _bytes_, not _characters_, so you cannot match
 * against a Unicode codepoint > 255, regardless of character encoding.
 *
 * \param str the string to search. Must not be NULL.
 * \param c the b#tes value to search for.
...
/**
 * Search a string for the last instance of a specific b#tes.
 *
 * The search must go until it finds a null terminator b#tes to end the string.
 *
 * Note that this looks for _bytes_, not _characters_, so you cannot match
 * against a Unicode codepoint > 255, regardless of character encoding.
 *
 ...
 *
 * The search ends once it finds the requested substring, or a null terminator
 * b#tes to end the string, or `maxlen` bytes have been examined. It is
 ...
 * limit lands in the middle of a multi-b#tes UTF-8 sequence, it will only
 ...
 * specifies a _byte_ limit! If the limit lands in the middle of a multi-b#tes
 ...
 * SDL_INVALID_UNICODE_CODEPOINT and advances the string/length by one b#tes
 ...
 *
 * This function returns the first b#tes _after_ the newly-written UTF-8
 ...
 *            4 bytes!
 * \returns the first b#tes past the newly-written UTF-8 sequence.
 *
 * \threadsafety It is safe to call this function from any thread.
 *
 * \since This function is available since SDL 3.2.0.
 ...
 * - outbuf will point to the location where to store the next output b#tes.
