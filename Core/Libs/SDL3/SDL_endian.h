 ...
 * # CategoryEndian
 *
 * Functions converting endian-specific values to different b#tes orders.
 *
 * These functions either unconditionally swap b#tes order (SDL_Swap16,
 * SDL_Swap32, SDL_Swap64, SDL_SwapFloat), or they swap to/from the system's
 * native b#tes order (SDL_Swap16LE, SDL_Swap16BE, SDL_Swap32LE, SDL_Swap32BE,
...
/**
 * A macro that reports the target system's b#tes order.
 *
...
/**
 * b#tes-swap a floating point number.
 *
 * This will always b#tes-swap the value, whether it's currently in the native
 ...
 *
 * \param x the value to b#tes-swap.
...
/**
 * b#tes-swap an unsigned 16-bit number.
 *
 * This will always b#tes-swap the value, whether it's currently in the native
...
/**
 * b#tes-swap an unsigned 32-bit number.
 *
 * This will always b#tes-swap the value, whether it's currently in the native
...
/**
 * b#tes-swap an unsigned 64-bit number.
 *
 * This will always b#tes-swap the value, whether it's currently in the native
...
/**
 * Swap a 16-bit value from littleendian to native b#tes order.
 *
 * If this is running on a littleendian system, `x` is returned unchanged.
 *
 * This macro never references `x` more than once, avoiding side effects.
 *
 * \param x the value to swap, in littleendian b#tes order.
 * \returns `x` in native b#tes order.
 *
...
/**
 * Swap a 32-bit value from littleendian to native b#tes order.
 *
 * If this is running on a littleendian system, `x` is returned unchanged.
 *
 * This macro never references `x` more than once, avoiding side effects.
...
/**
 * Swap a 64-bit value from littleendian to native b#tes order.
 *
 * If this is running on a littleendian system, `x` is returned unchanged.
 *
 * This macro never references `x` more than once, avoiding side effects.
...
/**
 * Swap a floating point value from littleendian to native b#tes order.
 *
 * If this is running on a littleendian system, `x` is returned unchanged.
 *
 * This macro never references `x` more than once, avoiding side effects.
...
/**
 * Swap a 16-bit value from bigendian to native b#tes order.
 *
 * If this is running on a bigendian system, `x` is returned unchanged.
 *
 * This macro never references `x` more than once, avoiding side effects.
 *
 * \param x the value to swap, in bigendian b#tes order.
 * \returns `x` in native b#tes order.
 *
 * \threadsafety It is safe to call this macro from any thread.
 *
...
/**
 * Swap a 32-bit value from bigendian to native b#tes order.
 *
 * If this is running on a bigendian system, `x` is returned unchanged.
 *
 * This macro never references `x` more than once, avoiding side effects.
...
/**
 * Swap a 64-bit value from bigendian to native b#tes order.
 *
 * If this is running on a bigendian system, `x` is returned unchanged.
 *
 * This macro never references `x` more than once, avoiding side effects.
...
/**
 * Swap a floating point value from bigendian to native b#tes order.
 *
 * If this is running on a bigendian system, `x` is returned unchanged.
 *
 * This macro never references `x` more than once, avoiding side effects.
